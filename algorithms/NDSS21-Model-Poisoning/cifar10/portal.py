...
def min_sum_bulyan_unknown_bening(nepochs=1200, fed_lr=0.5):
...
def min_sum_bulyan_known_bening(nepochs=1200, fed_lr=0.5):
    def our_attack_score(all_updates, model_re, n_attackers, dev_type='unit_vec'):
...
if __name__ == "__main__":
    ...
    if benign_known:
        if aggregation == "bulyan":
            ...
            if attack == "min-sum":
                min_sum_bulyan_known_bening(epoch, learning_rate)
    else:
        if aggregation == "bulyan":
            if attack == "fang":
            ...
            if attack == "min-sum":
                min_sum_bulyan_unknown_bening(epoch, learning_rate)
        if aggregation == "median":
            if attack == "fang":
            ...
            if attack == "min-sum":
                min_sum_median_unknown_bening(epoch, learning_rate)